...
- Simply put, the critical value represents how many standard deviations ( $\sigma$ ) an obtained value is away from the true mean ( $mu$ ) under the null hypothesis. 

---
# Critical Values for Common Significance Levels:
- One-tailed test ( $\alpha$= 0.05): Critical value z= $\pm$ 1.645.
- Two-tailed test ( $\alpha$= 0.05): $\alpha$ is split into 2.5% in each tail, leading to the widely used z= $\pm$ 1.96.
