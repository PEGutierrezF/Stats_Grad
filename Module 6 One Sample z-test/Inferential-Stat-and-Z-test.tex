...
z.test(x, y, alternative=`greater', mu=, sigma.x=,
sigma.y=NULL,conf.level=.95)

where:

x: values for the first sample alternative: the alternative hypothesis
(`greater', `less', `two.sided') mu: mean population. sigma.x:
