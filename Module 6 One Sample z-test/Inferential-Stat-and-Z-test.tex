...
\item
  ...
  This method tests for any difference between the sample and population
  mean, regardless of the direction of the difference. The null and
...
The tails in a distribution are the extreme regions where values of the
test statistic indicate significant evidence against the null
hypothesis, aligning with the alternative hypothesis.
\end{frame}
