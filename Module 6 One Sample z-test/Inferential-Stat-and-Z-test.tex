...
\begin{itemize}
\item
  \textbf{Tails in hypothesis testing} represent the critical regions
  where \textbf{extreme values} of the test statistic indicate
  significant differences. If the test statistic falls in one of the
  tails, we reject the null hypothesis in favor of the alternative
  hypothesis.
