...
```
    ...
    - \( N(\mu, \frac{\sigma^2}{n}) \): The normal distribution with mean \( \mu \) (the population mean) and variance \( \frac{\sigma^2}{n} \), where \( \sigma^2 \) is the population variance and \( n \) is the sample size.
