...
\tightlist
\item
  The sample mean \(\bar{X}_n\) will follow a normal distribution with
  mean \(\mu\) and standard deviation \(\frac{\sigma}{\sqrt{n}}\). As
  the sample size \(n\) increases, the standard deviation
  \(\frac{\sigma}{\sqrt{n}}\) decreases, making the sample mean a more
  accurate estimate of the population mean \(\mu\).\\
\end{itemize}
\end{frame}
