...
\item
  \(\bar{X}_n \sim N\left(\mu, \frac{\sigma}{\sqrt{n}}\right)\): The
  sample mean follows a normal distribution with mean \(\mu\) (the
  population mean) and population SD \(\sigma\) and \(n\) is the sample
  size.
\end{itemize}
\end{frame}
