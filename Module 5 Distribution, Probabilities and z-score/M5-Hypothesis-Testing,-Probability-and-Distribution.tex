...
\hypersetup{
  ...
  pdfauthor={Pablo E. Guti̩rrez-Fonseca},
  hidelinks,
...
\begin{column}{0.48\textwidth}
\includegraphics{M5-Hypothesis-Testing,-Probability-and-Distribution_files/figure-beamer/unnamed-chunk-12-1.pdf}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.48\textwidth}
\includegraphics{M5-Hypothesis-Testing,-Probability-and-Distribution_files/figure-beamer/unnamed-chunk-13-1.pdf}
\end{column}
\end{columns}
\end{frame}
