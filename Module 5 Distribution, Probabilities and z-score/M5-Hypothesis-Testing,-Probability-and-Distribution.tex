...
\begin{frame}{Hypothesis Testing: Null and alternative hypothesis}
\phantomsection\label{hypothesis-testing-null-and-alternative-hypothesis-1}
\begin{itemize}
\tightlist
\item
  A \textbf{null hypothesis} (denoted by \(H_0\)) is a statement of the
...
\begin{frame}{Focus - Types of Error}
\phantomsection\label{focus---types-of-error-3}
\begin{itemize}
\tightlist
\item
  \textbf{Explanation}:
...
\phantomsection\label{finding-probabilities-for-z-scores-using-r}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Finding probabilities for z-scores using R}
\phantomsection\label{finding-probabilities-for-z-scores-using-r-1}
\begin{columns}[T]
\begin{column}{0.5\textwidth}
\small
...
\begin{frame}{Finding probabilities for z-scores using R}
\phantomsection\label{finding-probabilities-for-z-scores-using-r-2}
\begin{columns}[T]
\begin{column}{0.5\textwidth}
\vspace{1cm}
...
\includegraphics{M5-Hypothesis-Testing,-Probability-and-Distribution_files/figure-beamer/unnamed-chunk-29-1.pdf}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.48\textwidth}
\includegraphics{M5-Hypothesis-Testing,-Probability-and-Distribution_files/figure-beamer/unnamed-chunk-30-1.pdf}
\end{column}
\end{columns}
\end{frame}
