...
\item
  ...
  mean () and standard deviation (), we designate this by writing
\end{itemize}
...
\begin{column}{0.48\textwidth}
\includegraphics{M5-Hypothesis-Testing,-Probability-and-Distribution_files/figure-beamer/unnamed-chunk-10-1.pdf}
\end{column}
\end{columns}
\end{frame}
