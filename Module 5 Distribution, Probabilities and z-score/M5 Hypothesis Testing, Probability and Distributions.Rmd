...
|----------|--------------------------|---------------------------|
| **Reject Null Hypothesis** | **Type I Error**: Incorrectly rejecting the null hypothesis when it is true. | **Correct Decision**: Correctly rejecting the null hypothesis when it is false. |
| **Fail to Reject Null Hypothesis** | **Correct Decision**: Correctly not rejecting the null hypothesis when it is true. | **Type II Error**: Incorrectly failing to reject the null hypothesis when it is false. |
