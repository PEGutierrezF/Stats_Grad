...
- Importance in Inferential Statistics:
  - Similar to the mean and standard deviation in one-sample tests, degrees of freedom is **a critical value** used in calculating test statistics for inferential tests.
