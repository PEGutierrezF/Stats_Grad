...
---
# Normality
- Test normality for each fertilizer group using the Shapiro-Wilk test: 
```{r}
...
- Check for equal variances across groups using Bartlett's test:
```{r}
...
- After the ANOVA, we need to compare pairs of groups to determine which ones differ significantly.
