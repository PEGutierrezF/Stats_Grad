...
---
# One-way ANOVA Summary Table
- Example: Sample Size 40, 6 groups
...
| Source  of<br/> variation          |   Degrees of <br/>Freedom (DF)   |     Sum of Squares<br/> (SS)     |     Mean Square<br/> (MS)   |        F-value        |
|-------------------|:----------------------------:|:----------------------------:|:-----------------------:|:---------------------:|
| **Between<br/> Groups** |          c - 1              |             SSB              |    MSB =<br/> SSB / (c - 1) |       MSB / MSW       |
| **Within<br/> Groups**  |          n - c              |             SSW              |    MSW =<br/> SSW / (n - c) |                       |
| **Total**          |          n - 1              |      SST =<br/> SSB + SSW        |         
...
| Source  of<br/> variation          |   Degrees of <br/>Freedom (DF)   |     Sum of Squares<br/> (SS)     |     Mean Square<br/> (MS)   |        F-value        |
|-------------------|:----------------------------:|:----------------------------:|:-----------------------:|:---------------------:|
| **Between<br/> Groups** |          5              |             SSB              |    MSB =<br/> SSB / (c - 1) |       MSB / MSW       |
| **Within<br/> Groups**  |          n - c              |             SSW              |    MSW =<br/> SSW / (n - c) |                       |
| **Total**          |          n - 1              |      SST =<br/> SSB + SSW        |         
...
|-------------------|:----------------------------:|:----------------------------:|:-----------------------:|:---------------------:|
| **Between<br/> Groups** |          5              |             SSB              |    MSB =<br/> SSB / (c - 1) |       MSB / MSW       |
| **Within<br/> Groups**  |          34              |             SSW              |    MSW =<br/> SSW / (n - c) |                       |
| **Total**          |          n - 1              |      SST =<br/> SSB + SSW        |         
