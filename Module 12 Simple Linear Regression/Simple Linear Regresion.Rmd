...
.small[   - Represents an exploration beyond the limits of observed data.
...
$\beta_1 = \frac{n \sum(xy) - \left( \sum x \right) \left( \sum y \right)}{n \sum(x^2) - \left( \sum x \right)^2} \Rightarrow \beta_1 = \frac{10 \times 1008 - 55 \times 127}{10 \times 3025 - 55^2}= 0.11$
...
$\beta_0 = \frac{\sum y}{n} - \beta_1 \frac{\sum x}{n} \Rightarrow \beta_0 = \frac{127}{10} - 0.11 \times \frac{55}{10} = 12.1$
...
points(0, intercept, pch = 16, col = "red", cex = 1.5)
text(0.5, intercept, paste("Intercept =", round(intercept, 1)), pos = 4, col = "red")

# Highlight and annotate the slope
slope_x1 <- 3
slope_y1 <- intercept + slope * slope_x1
segments(slope_x1, intercept, slope_x1, slope_y1, col = "purple", lty = 2)  # Vertical line
segments(slope_x1, slope_y1, 0, slope_y1, col = "purple", lty = 2)          # Horizontal line
text(slope_x1 + 0.5, slope_y1, paste("Slope =", round(slope, 2)), pos = 4, col = "purple")
