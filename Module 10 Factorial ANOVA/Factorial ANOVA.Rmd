...
2. **Factorial ANOVA**: Applied when there are **two or more treatment variables**. The name reflects the number of groups and variables, e.g., a 2x3 Factorial ANOVA. The non-parametric alternative is Friedman’s k-way test.
