...
DiagrammeR::mermaid("
    graph TD;
        ...
        Q --> R[Number of Treatments?]
        
        R --One--> S[Normally Distributed?]
        S --Yes--> T[One-Way ANOVA]
        S --No--> U[Non-Parametric ANOVA]
        
        R --More than One--> V[Normally Distributed?]
        
        V --Yes--> W[Factorial ANOVA]
        V --No--> X[Friedman's Rank Test]
